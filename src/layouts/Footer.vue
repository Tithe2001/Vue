	...
	<aside class="control-sidebar">
		...
		<div class="tab-content">
			...
			<div class="media py-10 px-0">
				...
				<img  :src="`${imgURL}/assets/images/avatar/1.html`" alt="...">
				</a>
			...
			<div class="media py-10 px-0">
				...
				<img  :src="`${imgURL}/assets/images/avatar/2.html`" alt="...">
				</a>
				<div class="media-body">
				<p class="fs-16">
			...
			<div class="media py-10 px-0">
				...
				<img  :src="`${imgURL}/assets/images/avatar/3.html`" alt="...">
				</a>
				<div class="media-body">
				<p class="fs-16">
			...
			<div class="media py-10 px-0">
				...
				<img  :src="`${imgURL}/assets/images/avatar/4.html`" alt="...">
				</a>
				<div class="media-body">
				<p class="fs-16">
					<a class="hover-primary" href="#"><strong>Evan</strong></a>
                ...
                <div class="chat-logs">
                    <div class="chat-msg user">
                        <div class="d-flex align-items-center">
                            <span class="msg-avatar">
                                <img :src="`${imgURL}/assets/images/avatar/2.jpg`" class="avatar avatar-lg">
                            </span>
                            <div class="mx-10">
                    ...
                    <div class="chat-msg self">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <span class="msg-avatar">
                                <img :src="`${imgURL}/assets/images/avatar/3.jpg`" class="avatar avatar-lg">
                            </span>
                        </div>
                        <div class="cm-msg-text">
