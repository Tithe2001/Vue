	...
	<div class="d-flex align-items-center logo-box justify-content-start">	
		...
		<a href="index-2.html" class="logo">
		  ...
		  <div class="logo-mini w-30">
			  <span class="light-logo"><img :src="`${imgURL}/assets/images/logo-letter.png`" alt="logo"></span>
			  <span class="dark-logo"><img :src="`${imgURL}/assets/images/logo-letter.png`" alt="logo"></span>
		  </div>
		  <div class="logo-lg">
			  <span class="light-logo"><img :src="`${imgURL}/assets/images/logo-dark-text.png`" alt="logo"></span>
			  <span class="dark-logo"><img :src="`${imgURL}/assets/images/logo-light-text.png`" alt="logo"></span>
		  </div>
		</a>	
	</div>  
    <!-- Header Navbar -->
        ...
        <ul class="nav navbar-nav">	
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="waves-effect waves-light dropdown-toggle no-border p-5" data-bs-toggle="dropdown" title="User">
				<img class="avatar avatar-pill" :src="`${imgURL}/assets/images/avatar/3.jpg`" alt="">
            </a>
